...
<br>
 <h1>The items we fix : </h1>
        ...
        <br>
        <br>
          <img src="4.jpeg"  style="width:40%" class="center">
    
      </div>
    </div>
    <h1> Our Techniciens: </h1>
        <div class="column">
          <img src="tech1.jpg"  style="width:100%">
        </div>
        <div class="column">
          <img src="tech2.jpeg"  style="width:100%">
        </div>
        <div class="column">
          <img src="tech3.jpeg"  style="width:100%">
        </div>
        <br>
        <br>
          <img src="tech4.jpg"  style="width:40%" class="center">
